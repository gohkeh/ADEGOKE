...
session_start();
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($msg) {
            ...
            $_SESSION['success'] = "You have updated the Voter's details successfully.";
...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    <main class="w-full flex-grow p-6">
        <h1 class="text-3xl text-black pb-6">Edit Voter's Details</h1>
        ...
        <div class="mt-7 bg-white p-7 sm:mx-auto sm:w-full sm:max-w-sm">
          <form class="space-y-6" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <input type="text" name="address" id="address" value="<?= htmlspecialchars($unique['address']) ?>" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <input type="phone" name="phone" id="phone" value="<?= htmlspecialchars($unique['phone']) ?>"  class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
            ...
            <div class="space-y-2">
                <h1 class="block text-sm font-medium leading-6 text-gray-900"><b>Voting Details</b></h1>
                <div class="relative">
                    <input type="number" name="idno" id="idno" value="<?= htmlspecialchars($unique['idno']) ?>"  class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " maxlength="10" oninput="this.value=this.value.slice(0,10)" />
