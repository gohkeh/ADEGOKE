...
session_start();
    ...
    $users = mysqli_query($conn, "SELECT * FROM `users` WHERE (`role` = 'voter') ORDER BY `id` DESC ");
...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    <main class="w-full flex-grow p-6">
        <h1 class="text-3xl text-black pb-6">Voters</h1>
        ...
        <div class="w-full mt-7">
            <div class="flex justify-between items-center mb-5">
                <p class="text-xl pb-3 flex items-center"><i class="fas fa-list mr-3"></i> Latest Voters</p>
                <a href="add_voter.php" class="bg-blue-900 text-white hover:bg-blue-700 hover:text-white rounded-md px-5 py-2 text-base font-medium flex items-center"><i class="fa fa-plus mr-2" aria-hidden="true"></i> Add New Voter</a>
            </div>
                ...
                <table class="min-w-full bg-white">
                    ...
                    <?php $id = 1; foreach ($users as $user) { ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="text-center py-3 px-2 text-blue-700"><a href="edit_voter.php?id=<?= $user['id']; ?>" class="hover:text-blue-500"><i class="fa fa-edit"></i></a></td>
                            ...
                            <td class="text-center py-3 px-2 text-red-700"><a href="voters.php?id=<?= $user['id']; ?>&func=delete" class="hover:text-red-500 delete-link-<?= $user['id']; ?>"><i class="fas fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                        <script>
